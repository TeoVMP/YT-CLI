...
def get_credentials():
    ...
    print("="*70)
    print("\n📖 GUÍA COMPLETA: Lee GUIA_CUENTA_COLECTIVA.md para instrucciones detalladas")
    print("\n💡 TIP: Ejecuta 'py main.py --generate-account' para generar nombres genéricos")
    print("\nResumen rápido:")
    print("1. Crea una cuenta de Google (puede ser con ProtonMail)")
    print("2. Ve a https://console.cloud.google.com/")
    print("3. Crea un proyecto")
    print("4. Habilita SOLO 'YouTube Data API v3' (NO Gmail API)")
    print("5. Crea credenciales OAuth2 tipo 'Aplicación de escritorio'")
    print("6. En 'Alcances', selecciona SOLO 'youtube.force-ssl' (NO Gmail)")
    print("7. Copia el Client ID y Client Secret\n")
    print("⚠️ IMPORTANTE: Solo habilita YouTube API, NO habilites Gmail API\n")
    print("="*70 + "\n")
