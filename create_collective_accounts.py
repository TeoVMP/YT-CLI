...
class CollectiveAccountCreator:
    ...
    def step_5_google_cloud_setup(self):
        ...
        print("   - Click 'CREAR'")
        print("4. Habilita YouTube Data API v3:")
        print("   - Ve a 'APIs y servicios' → 'Biblioteca'")
        print("   - Busca 'YouTube Data API v3'")
        print("   - Click 'HABILITAR'")
        print("5. Configura pantalla de consentimiento:")
        print("   - Ve a 'APIs y servicios' → 'Pantalla de consentimiento'")
        print("   - Tipo: 'Externo'")
        print("   - Nombre: 'YouTube Bot'")
        print("   - Alcances: SOLO 'youtube.force-ssl' (NO Gmail)")
        print("6. Crea credenciales OAuth2:")
        print("   - Ve a 'Credenciales' → 'Crear credenciales'")
        print("   - Tipo: 'ID de cliente OAuth 2.0'")
        print("   - Tipo aplicación: 'Aplicación de escritorio'")
        print("   - Nombre: 'YouTube Bot Desktop'")
        print("   - Click 'CREAR'")
